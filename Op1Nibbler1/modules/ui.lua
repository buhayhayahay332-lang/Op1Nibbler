return function(ctx, Modules)
    ...
    ESPColors:AddLabel("Players"):AddColorPicker("esp_pc", { Default = Modules.ESP.playerColor, Title = "Player" }):OnChanged(function(v) Modules.ESP:SetPlayerColor(v) end)
    ESPColors:AddLabel("Drone"):AddColorPicker("esp_dc", { Default = Modules.ESP.droneColor, Title = "Drone" }):OnChanged(function(v) Modules.ESP:SetDroneColor(v) end)
    ESPColors:AddLabel("Claymore"):AddColorPicker("esp_cc", { Default = Modules.ESP.claymoreColor, Title = "Claymore" }):OnChanged(function(v) Modules.ESP:SetClaymoreColor(v) end)
    ESPColors:AddLabel("Proximity"):AddColorPicker("esp_prc", { Default = Modules.ESP.proximityColor, Title = "Proximity" }):OnChanged(function(v) Modules.ESP:SetProximityColor(v) end)
    ESPColors:AddLabel("Sticky"):AddColorPicker("esp_sc", { Default = Modules.ESP.stickyColor, Title = "Sticky Camera" }):OnChanged(function(v) Modules.ESP:SetStickyColor(v) end)
