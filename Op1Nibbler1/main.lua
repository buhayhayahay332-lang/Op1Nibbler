...
local function buildLibraryUI(lib)
    ...
    aimbotSection:AddToggle({ Name = "Silent Aim Enabled", Flag = "silent_aim_enabled", Default = true, Callback = setSilentAim })
    ...
    aimbotSection:AddToggle({ Name = "Target Players", Flag = "silent_target_players", Default = true, Callback = function(v) setSilentAimTargets(v, nil, nil) end })
    aimbotSection:AddToggle({ Name = "Target Gadgets", Flag = "silent_target_gadgets", Default = true, Callback = function(v) setSilentAimTargets(nil, v, nil) end })
    aimbotSection:AddToggle({ Name = "Target Cameras", Flag = "silent_target_cameras", Default = true, Callback = function(v) setSilentAimTargets(nil, nil, v) end })

    weaponSection:AddToggle({ Name = "Gun Mod Enabled", Flag = "gun_mod_enabled", Default = true, Callback = setGunModEnabled })
    ...
    weaponSection:AddToggle({ Name = "No Spread", Flag = "gun_mod_spread", Default = true, Callback = function(v) setGunModConfig("no_spread", v) end })
    ...
    weaponSection:AddToggle({ Name = "Force Auto", Flag = "gun_mod_forceauto", Default = true, Callback = function(v) setGunModConfig("force_auto", v) end })
    weaponSection:AddToggle({ Name = "Instant ADS", Flag = "gun_mod_ads", Default = true, Callback = function(v) setGunModConfig("instant_ads", v) end })
    ...
    espSection:AddToggle({ Name = "ESP Enabled", Flag = "esp_enabled", Default = true, Callback = setEspEnabled })
    espSection:AddToggle({ Name = "ESP Team Check", Flag = "esp_team_check", Default = true, Callback = setEspTeamCheck })
    espSection:AddToggle({ Name = "Player ESP", Flag = "esp_players", Default = true, Callback = setEspPlayers })
    espSection:AddToggle({ Name = "Gadget ESP", Flag = "esp_objects", Default = true, Callback = setEspObjects })
    espSection:AddToggle({ Name = "Hitbox Enabled", Flag = "hitbox_enabled", Default = true, Callback = setHitboxEnabled })
    ...
    lightingSection:AddToggle({ Name = "Fullbright", Flag = "fullbright_enabled", Default = true, Callback = setFullbright })
