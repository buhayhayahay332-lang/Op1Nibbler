...
local FindFirstChild = function(self, ...) return typeof(self) == "Instance" and self:FindFirstChild(...) end
local WaitForChild = function(self, ...) return typeof(self) == "Instance" and self:WaitForChild(...) end
local IsA = function(self, ...) return typeof(self) == "Instance" and self:IsA(...) end
...
local FindFirstChildOfClass = function(self, ...)
	return typeof(self) == "Instance" and self:FindFirstChildOfClass(...)
end
...
local IsDescendantOf = function(self, ...)
	return typeof(self) == "Instance" and self:IsDescendantOf(...)
end
...
-- patched: allow multiple local Exunys cores in one script
